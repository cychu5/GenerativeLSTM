...
from tensorflow.keras.layers import Input, Embedding, Concatenate, Dot
...
# =============================================================================
    ...
    concatenate = Concatenate(name='concatenated', axis=2)([merged, t_input, sf_input])
